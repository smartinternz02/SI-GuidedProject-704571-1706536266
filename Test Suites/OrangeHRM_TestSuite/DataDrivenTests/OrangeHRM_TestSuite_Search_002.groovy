 ...
 */
@SetupTestCase() // Please change skipped to be false to activate this method.
def setupTestCase() {
	CustomKeywords.'commonUtils.Utils.clearText'(findTestObject('OrangeHRMPages/OrangeHRM_Search_OR/input_Admin_oxd-input oxd-input--focus'))
}
